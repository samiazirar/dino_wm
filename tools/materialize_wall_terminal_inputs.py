...
# Keep the terminal producer on the exact accepted Wall source.  The canonical
# producer later gained deterministic-execution settings, which intentionally
# have a different provenance identity from the accepted cache.
from tools.wall_terminal_precompute_depth_a820029 import (  # noqa: E402
    ARTIFACTS,
    CHUNK_SIZE,
    ContractError,
...
EXPECTED_VALIDATION_EVIDENCE_SHA256 = (
    "d66b964aec8deafdd72ddda2f67d0c7866eddb3a4a12cb0100d5512180db3ae7"
)
